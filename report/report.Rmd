...
s2c <- read.table(s2c_file, header = TRUE, stringsAsFactors=FALSE,sep=",",colClasses=c("character","character","character"))
```
...
If no contrast file was provided, this step is skipped.

```{r, echo=FALSE,include=FALSE, results='asis',comment=''}
out = NULL
contrast_logic =  as.logical(params$contrast_logic)
if (contrast_logic){
...
if (!contrast_logic){
  cat("**Download the full [Table](../deseq/table.csv) here.**\n")
  cat("\n")
}
```
