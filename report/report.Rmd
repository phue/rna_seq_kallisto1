...
The different tabs in this report should be self explainatory, if anything is confussing please ask me (in person or by [email](mailto:elin.axelsson@gmi.oeaw.ac.at))
...
```
All scripts used are available [here](../used_script/) and the nrxtflow script itself is stored [here](../nextflow/rna_seq1.nf).
